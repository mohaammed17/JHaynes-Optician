      ...
      <div className="container">
        <div className="row justify-content-center animate__animated animate__fadeInUp">
          <div className="col-lg-10">
            <h2 className="text-center text-primary fw-bold mb-4">Prescription Safety Glasses</h2>
            <div className="card shadow border-0 rounded-4 p-4 bg-white">
              <h5 className="text-info fw-bold mb-3">Protecting Your Vision at Work and at Home</h5>
              ...
              <p className="text-muted" style={{ textAlign: 'justify' }}>
                📍 Visit us to learn more about our safety eyewear options and how we can support your organisation’s eye protection needs.
              </p>
            </div>
          </div>
        </div>
