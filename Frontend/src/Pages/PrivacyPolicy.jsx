  ...
  return (
    <div className="container py-5 animate__animated animate__fadeIn">
      ...
      <div className="card shadow border-0 rounded-4 p-4 bg-white">
        ...
        <p className="text-muted" style={{ textAlign: 'justify' }}>
          The data controller is Zahra Eyecare Ltd, trading as J Haynes Optician. Company registration number: 12927169. GOC number: CO-33453.
        </p>
        ...
        <ul className="text-muted" style={{ textAlign: 'justify' }}>
          <li>Your name</li>
          <li>Date of Birth</li>
          <li>Contact telephone numbers (including mobile)</li>
          <li>Email and postal address</li>
          <li>Details of any prescription supplied by your healthcare professional</li>
          <li>Information filled in on forms on the Website</li>
          <li>Details of visits and transactions on the Website</li>
        </ul>
        ...
        <ul className="text-muted" style={{ textAlign: 'justify' }}>
          ...
          <li>Processing your personal information so that the Group can inform you about new healthcare related products and services available from the Group</li>
          <li>Processing your personal information to enhance the services and goods the Group makes available to its customers</li>
          <li>Processing your personal data to conduct research about your health and shopping habits</li>
        ...
        <ul className="text-muted" style={{ textAlign: 'justify' }}>
          ...
          <li>In the event that the Group sells or buys any business or assets, in which case we may disclose your personal information to the prospective buyer or seller</li>
          <li>Any agents or subcontractors that process data on our behalf</li>
